...
public class LanguageSettings  extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 1. Add language name (i.e English, French) to language_choices.xml Like  `<item>English</item>`
        // 2. Add language to HashMap below (i.e `languages.put("English", "en");`)
        // 3. Create folder with language short hand as the name (i.e "en", "fr") in "assets/bible/" (i.e "assets/bible/fr/")
        ...
        //set the spinner val
        languageSelector.setSelection(adapter.getPosition(sharedPreferences.getString("language", "en")));
